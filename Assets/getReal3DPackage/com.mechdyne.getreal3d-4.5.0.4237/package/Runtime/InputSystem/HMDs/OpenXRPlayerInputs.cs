...
namespace getReal3D
{
    ...
    public class OpenXRPlayerInputs : MonoBehaviour, PlayerInputs
    {
        ...
        public InputAction RotateAction;             //!< Rotation axes action
        public InputAction WandLookButtonAction;     //!< WandLook button action
        public InputAction WandDriveButtonAction;    //!< WandDrive button action
        public InputAction NavigateAction;           //!< Navigation axes action
        public InputAction TreadmillAction;          //!< Treadmill axes action
        public InputAction NavSpeedButtonAction;     //!< NavSpeed button action
        public InputAction JumpButtonAction;         //!< Jump button action
        public InputAction WandButtonAction;         //!< Wand button action
        public InputAction ChangeWandButtonAction;   //!< ChangeWand button action
        public InputAction ResetButtonAction;        //!< Reset button action
