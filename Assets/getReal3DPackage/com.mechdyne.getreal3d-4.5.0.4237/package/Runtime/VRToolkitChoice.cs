...
namespace getReal3D
{
    ...
    {
        /// This represents what GameObject should be enabled, depending on the device XR name.
        [System.Serializable]
        ...
        void OnGUI()
        {
            ...
            GUILayout.BeginVertical("VR Device", UnityEngine.GUI.skin.window);
        ...
        void Setup(VRToolkit toolkit)
        {
            ...
            var wandEventModule = Plugin.FindAnyObjectByType<GenericWandEventModule>();
            if (wandEventModule)
            {
